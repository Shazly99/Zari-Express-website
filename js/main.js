...
sel.addEventListener('click', () => {
    ...
    if (active === true) {
        ...
        $('.feature .one').text('نوفر صفحة خاصة لكل مصنع وتستطيع اضافة صورك وشهاداتك وبيانات التواصل الخاصة بيك ورفع منتجاتك.');
        ...
        $('.feature .five').text('   يمكن للمستورد طرح مناقصات وتقوم المصانع بتقديم عروض الاسعار.');
        $('.feature .six').text('‌    التعامل المباشر بين المستورد والمصدر بدون اي عمولات علي البيع.');
        $('.feature .seven').text('   تستطيع عرض خدماتك التي توفرها.'     );
        $('.feature .eight').text('  سنساعدك على تحسين مشروعك و زيادة مبيعاتك.');
